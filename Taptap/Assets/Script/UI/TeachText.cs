        ...
        switch (talkCount)
        {
            case 0:
                ...
                {    
                    ...
                    "下一个波次的怪物不同于刚刚我们遇到的怪物，它具有绿色特征的身体，因此它必须要用绿色灯塔照亮的防御塔来抵御。",
                    "待怪物消失后，点击右下角的拆除按钮，依次拆除防御塔与灯塔，将原本的红色煤油灯替换为绿色煤油灯后，再次建造防御塔点击迎敌按钮。",
                    "怪物进入终点会造成扣血！血量将会随着收集到怪物死亡掉落的色块慢慢恢复，但当角色显示黑白图案时，说明你的角色岌岌可危，无法再承受更多伤害了。",
                    "再次点击出怪按钮。",
                    "你完成本关的教程了！"
                });
                break;
