        ...
        switch (talkCount)
        {
            case 0:
                ...
                {    
                    ...
                    "现在，在建筑栏里选择红色的煤油灯，在地图的中心位置花费初始的光之精华建造你的第一个灯塔！(按Down继续)",
                    "趁热打灯，在煤油灯旁建造你的第一个水晶防御塔吧！(按Down继续)",
                    "你已经成功地构筑了你的防线！在红色灯塔内的防御塔会造成红色伤害，有效打击红色的敌人。(按Down继续)",
                    "现在你可以点击迎敌按钮放出敌人了，敌人死亡时，会掉落相应的光之精华。注意，敌人来袭时无法建造任何建筑！(按Down继续)",
                    "下一个波次的怪物不同于刚刚我们遇到的怪物，它具有绿色特征的身体，因此它必须要用绿色灯塔照亮的防御塔来抵御。(按Down继续)",
                    "待怪物消失后，点击右下角的拆除按钮，依次拆除防御塔与灯塔，将原本的红色煤油灯替换为绿色煤油灯后，再次建造防御塔点击迎敌按钮。(按Down继续)",
                    "怪物进入终点会造成扣血！血量将会随着收集到怪物死亡掉落的色块慢慢恢复，但当角色显示黑白图案时，说明你的角色岌岌可危，无法再承受更多伤害了。(按Down继续)",
                    "再次点击出怪按钮。(按Down继续)",
                    "你完成本关的教程了！"
                });
                break;
